...
var HTMLgithub = '<li class="flex-item"><span class="white-text">github</span><span class="white-text">%data%</span></li>';
...
var HTMLskillsStart = '<h2 id="skills">Skills at a Glance:</h2><ul id="skills" class="flex-box"></ul>';
var HTMLskills = '<div class="flex-item"><span class="white-text">%data%</span></div';  //changed to a div element.
